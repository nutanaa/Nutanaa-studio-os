...
import { IConfigurationManager, IConfigurationProfile, IConfigurationExport, IConfigurationSchema } from '../common/configurationManager.js';
import { IRuntimeEventBus } from '../common/runtimeEventBus.js';
import { IRuntimeStateService } from '../common/runtimeState.js';
import { InstantiationType, registerSingleton } from '../../../../platform/instantiation/common/instantiation.js';
...
class ConfigurationManager extends Disposable implements IConfigurationManager {
	...
	onDidChange(
		event: (keys: Array<{ key: string; profile: string }>) => void
	): import('../../../../base/common/dispose.js'). IDisposable {
		return this._onDidChange.event(event);
	}
