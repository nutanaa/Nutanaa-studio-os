...
import { IHealthManager, HealthStatus, IHealthCheckResult } from '../common/healthManager.js';
...
registerSingleton(IHealthManager, HealthManager, InstantiationType.Delayed);
