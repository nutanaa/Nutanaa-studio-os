...
export interface IAuthenticationManager {
	 ...
	 */
	readonly onDidLogin: import('../../../../../base/common/event.js').Event<{ user: IUser; providerId: string }>;

	/**
	 * Event fired when user logs out.
	 */
	readonly onDidLogout: import('../../../../../base/common/event.js').Event<{ userId: string; reason: string }>;

	/**
	 * Event fired when session expires.
	 */
	readonly onDidSessionExpire: import('../../../../../base/common/event.js').Event<{ sessionId: string }>;
}