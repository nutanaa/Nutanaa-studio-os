...
import { ITrace, ITraceSpan, ITraceQuery } from '../../models/productionModel.js';
...
export interface ITracingManager {
	 ...
	 */
	onDidCreateTrace: Event<ITrace>;

	/**
	 * Event fired when a span is completed.
	 */
	onDidCompleteSpan: Event<{ traceId: string; span: ITraceSpan }>;
}