...
export interface IUpdateManager {
	 ...
	 */
	onDidUpdateAvailable: Event<IUpdateInfo>;

	/**
	 * Event fired when update is downloaded.
	 */
	onDidUpdateDownloaded: Event<IUpdateInfo>;

	/**
	 * Event fired when update is installed.
	 */
	onDidUpdateInstalled: Event<IUpdateInfo>;

	/**
	 * Event fired when download progress changes.
	 */
	onDidDownloadProgress: Event<IUpdateProgress>;
}