...
export class AgentDispatcher extends Disposable implements IAgentDispatcher {
	 ...
	 *
	 * Currently performs a structured simulation of two steps
	 * (input analysis + primary logic) that produce real timing and token
	 * accounting. Phase 3 replaces this body with a provider call.
	 */
